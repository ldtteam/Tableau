...
### Overriding the published version
To support snapshots it might be needed that you configure the published minecraft version.
To do this set the version in the `curse` block:
...
tableau {
    curse {
        publishedMinecraftVersion = "26.1-snapshot"
    }
}
```
</TabItem>
...
tableau {
    curse {
        publishedMinecraftVersion.set("26.1-snapshot")
    }
}
```
</TabItem>
