...
title: Shadowing dependencies into the mod JAR
slug: shadow
---
...
When you build a mod, you can shadow dependencies in the mod JAR file. This is useful when you want to distribute your mod as a single JAR file.
...
:::note
You can find a full example of this project configuration in the [Shadowing Example](https://github.com/ldtteam/Tableau/tree/main/examples/shadowing) on GitHub.
:::